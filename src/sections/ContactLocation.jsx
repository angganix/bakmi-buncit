        ...
        <section id="contact-location" className="px-4 md:px-24 py-24 pb-32 relative z-20 bg-gradient-to-bl from-amber-200 to-amber-500 overflow-x-hidden">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-4">
                {outlets?.map((item, index) => (
                    <div key={index} className="relative transform hover:scale-105 transition-all duration-200 ease-in-out p-4 text-white rounded-xl bg-gradient-to-br from-green-800 via-green-700 to-green-600">
